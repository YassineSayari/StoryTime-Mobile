...
import 'package:storytime/profile/profile_edit.dart';
      ...
      body: Column(
        children: [
          Expanded(flex: 2, child: _TopPortion(user: user)),
                            Text(
                    "${user.fullName}",
                    style: TextStyle(fontSize: 30, fontWeight: FontWeight.w600,fontFamily: AppTheme.fontName),
                  ),
          Expanded(
            flex: 6,
            child: Padding(
             ...
             children: [
              Row(
                children: [
                  ...
                  Text("Info",
                  style: TextStyle(fontSize: 35,fontWeight: FontWeight.bold,fontFamily: AppTheme.fontName),
                  ),
                  Spacer(),
        ...
        builder: (context) => EditProfile(user: user),
                ...
                children: [
                  ...
                  Flexible(
                    child: Text(
                      " Address",
                      style: TextStyle(fontSize: 25,fontFamily: AppTheme.fontName),
...
class SecuritySettings extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
                        Text("Change Password",style: TextStyle(fontSize: 35,fontWeight: FontWeight.w600,fontFamily: AppTheme.fontName),),
                          TextFormField(
              ...
              ElevatedButton(
                ...
                child: Text('Change Password',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 25,fontFamily: AppTheme.fontName ),),
...
class _TopPortion extends StatelessWidget {
  ...
  final String imageUrl = "$baseUrl/static/images";
   final String noImageUrl = "$baseUrl/static/images/16-02-2024--no-image.jpg";
